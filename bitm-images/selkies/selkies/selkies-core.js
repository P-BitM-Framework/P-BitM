...
// Base64 cursor 
const DEFAULT_CURSOR = "";
const TYPE_CURSOR = "";
const POINTER_CURSOR = "";
...
const authToken = urlParams.get('token') || fragmentParams.get('token');
      ...
      if (event.data === 'MODE websockets') {
        ...
        if (event.data.startsWith('{')) {
          ...
          try {
            ...
            // TODO: Grab cursor data and change with OS cursor
            // cursorData ='
            // {
            //     "curdata": "",
            //     "width": 18,
            //     "height": 25,
            //     "hotx": 4,
            //     "hoty": 2,
            ...
            if (cursorData.curdata) {
              switch (cursorData.curdata) {
                case DEFAULT_CURSOR:
                  overlayInput.style.cursor = 'default';
                  break;
                  case TYPE_CURSOR:
                  overlayInput.style.cursor = 'text';
                  break;
                case POINTER_CURSOR:
                  overlayInput.style.cursor = 'pointer';
                  break;
                default:
                  overlayInput.style.cursor = "default";
                  break;
...
function initiateFallback(error, context) {
    ...
    if (isSharedMode) {
        ...
        setIntParam('framerate', 120);
        setIntParam('h264_crf', 25);
        setBoolParam('is_manual_resolution_mode', false);
        setIntParam('manual_width', null);
        setIntParam('manual_height', null);
        getBoolParam('useCssScaling', true);
...
// --------------------------------------------------------------------------
// --- DPR watcher (Mac/HiDPI fix) ---
const BASE_DPI = 96;
let dprCleanup = null;

function applyCssDpiFromDpr() {
  const dpr = window.devicePixelRatio || 1;
  const dpi = Math.round(BASE_DPI * dpr);

  // Persisti un parametro che poi usi dove applichi lo scaling CSS/renderer.
...
function watchDevicePixelRatio() {
  // disarma watcher precedente
  if (dprCleanup) dprCleanup();

  const mq = window.matchMedia(`(resolution: ${window.devicePixelRatio}dppx)`);
  const handler = () => {
    applyCssDpiFromDpr();
    watchDevicePixelRatio(); // re-arm con il nuovo DPR
  };
